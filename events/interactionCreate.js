...
const CANAL_APROVACAO_POST_ID = process.env.POST_APPROVAL_CHANNEL_ID;
    ...
    async execute(interaction) {
        try {
            ...
            if (interaction.customId === 'abrir_postagem') {
                const sessionsPath = path.join(__dirname, '../post_sessions.json');

                let postSessions = {};
                if (fs.existsSync(sessionsPath)) {
                    delete require.cache[require.resolve('../post_sessions.json')];
                    postSessions = require('../post_sessions.json');
                }
                ...
                fs.writeFileSync(sessionsPath, JSON.stringify(postSessions, null, 2));
                ...
                try {
                    ...
                    console.error('Erro ao enviar DM de postagem:', error);
            ...
            if (interaction.customId.startsWith('aprovar_post_')) {
                ...
                if (fs.existsSync(pendingPath)) {
                    ...
                    pendingPosts = require('../pending_posts.json');
                }
                ...
                try {
                    ...
                    fs.writeFileSync(pendingPath, JSON.stringify(pendingPosts, null, 2));
